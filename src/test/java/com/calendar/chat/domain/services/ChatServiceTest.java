...
class ChatServiceTest {
        ...
        void readOrCreateConversation_Existing() {
                ...
                ConversationDetail detail = new ConversationDetail(UUID.randomUUID().toString(), participants, null,
                                null, List.of(),
                                0);
        ...
        void readConversationById_Success() {
                String convId = UUID.randomUUID().toString();
                ConversationDetail detail = new ConversationDetail(convId, List.of(), null, null, List.of(), 0);
